...
- build 镜像
```
docker build -f app/mgr/Dockerfile --build-arg APP_RELATIVE_PATH=mgr -t mgr . &&
...
docker run --rm  -p 10000:8000 --network deply_software_network  -v /www/wwwroot/austin-v2/app/msgpusher-manager/configs:/data/conf msgpusher-manager
